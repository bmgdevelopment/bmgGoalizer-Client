...
export const GoalForm = () => {
  ...
  const handleSaveGoal = () => {
    ...
    if (
      ...
      goal.description &&
      goal.folder_id &&
      goal.is_complete.length &&
      goal.is_favorite.length
    ) {
      if (showGoalForm) {
          ...
          <div className="">
            ...
            <fieldset className="goalFieldSet">
              ...
              >
                ...
                <option value={updateGoalView ? "false" : "False"}>
                  Not quite...
                </option>
                <option value={updateGoalView ? "true" : "True"}>
                  Yes, indeed!
                </option>
              </select>
            </fieldset>
